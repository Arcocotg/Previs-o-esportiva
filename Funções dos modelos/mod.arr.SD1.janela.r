mod.arr.SD1.janela <- function(tab, comp.nome = NULL, plot = F) {
  
  # Criar o nome do arquivo dinamicamente
  arquivo_saida <- paste0("prev.mod.arr.SD1.janela", comp.nome, ".csv")
  ...
  ### constroi o vetor indice 
  {
    ...
    times0 <- sort(union(tab_sem$mand,tab_sem$vist))
  }
