...
mod.ufmg.simulnormal.ano <- function(tab, p = 5, comp.nome = NULL, plot = F){
  
  # Criar o nome do arquivo dinamicamente
  arquivo_saida <- paste0("prev.mod.ufmg.simulnormal.ano", comp.nome, ".csv")
  ...
  for (i in 1:nrow(tab)) {
    ...
    #simulação da proporção em cada entervalo
