mod.arr.chance2.ano <- function(tab, comp.nome = NULL, plot = F) {
  
  # Criar o nome do arquivo dinamicamente
  arquivo_saida <- paste0("prev.mod.arr.chance2.ano", comp.nome, ".csv")
  ...
  ### constroi o vetor indice 
  {
    ...
    times0 <- sort(unique(c(tab_ano$mand,tab_ano$vist)))
  }
